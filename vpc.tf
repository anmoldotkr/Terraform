...
resource "aws_instance" "my-test-ec2-insta" {
  count = 2  # meta argument || why add here suppose we need multiple ec2 then with the help of this count this single block can make 2 ec2 instance's
  ...
  # running shell script for installing nginx, instead of righting here we are import file here.
